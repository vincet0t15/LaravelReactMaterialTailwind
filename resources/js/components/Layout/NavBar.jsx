...
export default function NavBar({ isOpen }) {
    ...
    return (
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-blue-gray-800  fixed left-0 right-0 top-0 z-50">
            <div className="flex flex-wrap justify-between items-center">
                ...
                <div className="flex items-center lg:order-2">
                    ...
                    <Menu>
                        ...
                        <MenuList className="dark:text-white dark:bg-blue-gray-800">
